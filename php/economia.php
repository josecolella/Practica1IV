	...
	<section id="newspaper">
		<header>
			...
			<section>
				<nav id="Tabs">
					<ul>
						...
						<li class="selected"><a class="redSection" href="internacional.html">Internacional</a></li>
			...
			<section class="sectionName">
				<h2 class="greenSection">Econom&iacute;a</h2>
			</section>
			<section class="highlightedStory">
				<h3 class="greenSection"><a href="internacional/Compromiso_llegado_creacion_gobierno_20130427.php">Nuevo Gobierno en Italia</a></h3>
			...
			<section id="leftNewsGrouping">
				<article class="newsStory">
					<h3 class="headline greenSection">Madre Boston bombardeo sospechosos lamenta la emigración a EE.UU.</h3>
				...
				<article class="newsStory">
					<h3 class="headline greenSection">Elecciones en Islandia</h3>
				...
				<article class="newsStory">
					<h3 class="headline greenSection">Los muertos en Bangladesh pasan 400</h3>
				...
				<article class="newsStory">
					<h3 class="headline greenSection">H7N9, virus aviario es una "amenaza grave" - advierten investigadores</h3>
			...
			<section id="centerNewsGrouping">
				<article class="newsStory">
					<h3 class="headline greenSection">Barack Obama dice prisión de Guantánamo debe cerrarse</h3>
				...
				<article class="newsStory">
					<h3 class="headline greenSection">Una niña de cinco años de edad muere en la region de India Madhya Pradesh</h3>
				...
				<article class="newsStory">
					<h3 class="headline greenSection">Islamista francés capturado 'después de luchar "en Malí</h3>
