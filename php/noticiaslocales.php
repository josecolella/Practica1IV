	...
	<section id="newspaper">
		<header>
			...
			<section class="sectionName">
				<h2 class="blueSection">Noticias Locales</h2>
			</section>
			<section class="highlightedStory">
				<h3 class="blueSection"><a href="internacional/Compromiso_llegado_creacion_gobierno_20130427.php">Nuevo Gobierno en Italia</a></h3>
			...
			<section id="leftNewsGrouping">
				<article class="newsStory">
					<h3 class="headline blueSection">Madre Boston bombardeo sospechosos lamenta la emigración a EE.UU.</h3>
				...
				<article class="newsStory">
					<h3 class="headline blueSection">Elecciones en Islandia</h3>
				...
				<article class="newsStory">
					<h3 class="headline blueSection">Los muertos en Bangladesh pasan 400</h3>
				...
				<article class="newsStory">
					<h3 class="headline blueSection">H7N9, virus aviario es una "amenaza grave" - advierten investigadores</h3>
			...
			<section id="centerNewsGrouping">
				<article class="newsStory">
					<h3 class="headline blueSection">Barack Obama dice prisión de Guantánamo debe cerrarse</h3>
				...
				<article class="newsStory">
					<h3 class="headline blueSection">Una niña de cinco años de edad muere en la region de India Madhya Pradesh</h3>
				...
				<article class="newsStory">
					<h3 class="headline blueSection">Islamista francés capturado 'después de luchar "en Malí</h3>
